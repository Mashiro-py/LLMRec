...
def set_template(args):
    if args.dataset_code == None:
        ...
        dataset_code = {'1': 'ml-100k', 'b': 'beauty', 'g': 'games', '2': 'mooc_data'}
        args.dataset_code = dataset_code["2"]
...
parser.add_argument("--text_embedding_path", default='./process_data/clip_text_features.pt', type=str)
parser.add_argument("--pretrain_emb_dim", type=int, default=1024, help="pretrain_emb_dim of clip model")
...
parser.add_argument('--val_iterations', type=int, default=6000)  # only for iteration val_strategy
...
# LLM Model
################
parser.add_argument('--llm_base_model', type=str, default='./pretrained/shakechen/Llama-2-7b-hf')
parser.add_argument('--llm_base_tokenizer', type=str, default='./pretrained/shakechen/Llama-2-7b-hf')
parser.add_argument('--llm_max_title_len', type=int, default=64)
...
parser.add_argument('--llm_retrieved_path', type=str, default="./experiments/lru/mooc_data")
...
parser.add_argument('--lora_num_epochs', type=int, default=0.0001)
parser.add_argument('--lora_val_iterations', type=int, default=2)
